    ...
    const getAllData = () => {
        AsyncStorage.getItem('userToken').then(val => {
            if (val != null) {
                ...
                fetch(`${BASE_URL}/child_member_points`, {
                    method: 'POST',
                    headers: {
